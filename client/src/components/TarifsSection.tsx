    ...
    >
      <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 2rem" }}>
          ...
          <div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "40px" }} className="tarifs-two-col">
              ...
              <div>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
                  {[
                    { label: "Pack 6 Privées/valable 2semaines", detail: "6 séances", price: "150 000"},
                    { label: "Pack 12 Privées/valable 3semaines", detail: "12 séances", price: "240 000",highlight: true },
                    { label: "Pack 20 Privées/valable 6semaines", detail: "20 séances/mois", price: "370 000"},
                  ].map((item) => (
                    <div
                      key={item.label}
                      style={{
        ...
        {activeTab === "entreprise" && (
          <div>
            <p style={{ textAlign: "center", fontSize: "13px", color: "#8A7E70", marginBottom: "40px" }}>
              Programmes wellness sur site — Abidjan & environs · Jusqu'à 8 participants max
            </p>
              ...
              {[
                {
                  ...
                  detail: "Jusqu'à 8 participants max · Séance unique",
                  price: "100 000",
                  icon: "🤝",
                  highlight: false,
                },
                {
                  ...
                  detail: "4 séances/mois · Jusqu'à 8 participants max",
                  price: "350 000",
                  icon: "📅",
                  highlight: true,
                },
