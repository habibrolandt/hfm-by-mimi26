...
const formules = [
  {
    ...
    price: "100 000",
    seances: "1 séance",
    features: ["Jusqu'à 8 participants", "Cours collectif sur site", "Matériel fourni par HFM", "Animateur Coach Mimi"],
    highlight: false,
  },
  {
    ...
    features: ["Jusqu'à 8 participants max", "4 cours collectifs/mois", "Planning flexible", "Rapport mensuel bien-être", "Suivi personnalisé"],
    highlight: true,
  },
  {
