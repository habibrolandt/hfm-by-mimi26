...
const tarifsDomicile = [
  { group: "Cours collectifs de 4 à 8 persones maximum", price: "15 000 F", per: "/Personnes", highlight: false },

];

const packsMenuels = [
  { name: "PACK 6", seances: "6 séances privées/valable 2 semaines", p12: "150 000 F"},
  { name: "PACK 12", seances: "12 séances privées/valable 3 semaines", p12: "240 000 F" },
  { name: "PACK 20", seances: "20 séances/valable 6 semaines", p12: "360 000 F" },
];
    ...
    >
      <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 2rem" }}>
        ...
        >
          ...
          <div>
            <div className="section-label reveal">Cours Collectifs</div>
            <h2
              className="reveal reveal-delay-1"
              style={{
                fontFamily: "'Playfair Display', serif",
